...
const MainView = () => {
  ...
  return (
    ...
    >
      ...
      >
        <SpeedometerGauge
          value={incomeTransactions?.length ?? 0}
          maxValue={50}
        />
        <Box sx={{ textAlign: "center", mt: 3 }}>
          ...
          >
            <Box sx={{ display: { xs: "none", sm: "block" } }}>
              <WarningIcon
                sx={{ color: speedometerMessage.color, fontSize: "2rem" }}
              />
            </Box>
            <Typography
              variant="h3"
          ...
          <MetricsCard
            ...
            subtitle={
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Typography
                  variant="caption"
                  sx={{ color: "#10b981", fontSize: "0.7rem", fontWeight: 600 }}
                >
                  Estas a {50 - totalTransactions} transacciones de ser
                  tributado.
                </Typography>
              </Box>
            }
